...
import javax.json.*;
/**
 * <p>Clase para verificar las métricas e indicadores</p>
 * <p>La API incluye sus métricas e indicadores por defecto en la carpeta resources, en el fichero a4iDefault.json</p>
 * <p>Si la aplicación cliente crea nuevas métricas o indicadores las guarda en un fichero json de configuración, que tendrá que indicársele al Checker</p>
 * <p>Deuda técnica: analizar la posibilidad de leer sólo una vez y mantener en memoria</p>
 * @author Isabel Román
 *
 */
public class Checker{
	...
	/**
	 * <p>Comprueba si la métrica está definida en el fichero por defecto o en el de la aplicación cliente</p>
	 * <p>También verifica que el tipo es el adecuado</p> 
	 * @param metricName nombre de la métrica que se quiere comprobar
	 * @return true si la métrica está definida
	...
	/**
	 * <p>Comprueba si el indicador está definido en el fichero por defecto o en el de la aplicación cliente</p>
	 * <p>También verifica que el tipo es el adecuado</p> 
