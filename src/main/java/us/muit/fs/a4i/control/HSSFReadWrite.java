...
==================================================================== */
/**
 * Esta clase desaparecerá, es sólo para probar las características de la librería apache.poi
 * No es propia, está sacada de la documentación que proveen los autores de la librería
 */
 ...
 * 
 * Extraído de la documentación online de la librería
 *
...
public final class HSSFReadWrite {
        ...
        try (HSSFWorkbook wb = new HSSFWorkbook();
            ...
            for (rownum = 0; rownum < 300; rownum++) {
                ...
                for (int cellnum = 0; cellnum < 50; cellnum += 2) {
                    ...
                    c.setCellValue(new HSSFRichTextString("HOLA"));
          ...
          //Si comento la siguiente linea la hoja aparece, si no la hoja no está  
            wb.removeSheetAt(1);
     ...
     * Method main
     * 
     * Pruebo con argumentos: output write para generar un fichero output.xls, ya que he
     * incluido en el código que se añada la extensión .xls al parámetro de entrada
     *
